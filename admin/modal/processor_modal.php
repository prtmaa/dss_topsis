<div class="modal fade" id="Modal<?php echo $pro['id_kriteria']; ?>" tabindex="-1" aria-labelledby="Modal<?php echo $pro['id_kriteria']; ?>" aria-hidden="true">
    <div class="modal-dialog">
        <div class="modal-content">
            ...
            <div class="modal-footer">
                <button type="submit" name="aksi" value="processor" class="btn btn-success">Simpan</button>
