<div class="modal fade" id="Modalos<?php echo $os['id_kriteria']; ?>" tabindex="-1" aria-labelledby="Modalos<?php echo $os['id_kriteria']; ?>" aria-hidden="true">
    <div class="modal-dialog">
        <div class="modal-content">
            ...
            <div class="modal-footer">
                <button type="submit" name="aksi" value="os" class="btn btn-success">Simpan</button>
